...
class DrawingSystemTestCase(unittest.TestCase):
	...
	def test_draw_stroke_1(self):
		stroke = self.strokeFactory.generateStrokeByParameters("橫", [222], startPoint=(20, 123))
		self.ds.draw(stroke)
		self.assertEqual("0.20.123,1.242.123", self.controller.getStrokeExpression())

	def test_draw_stroke_2(self):
		stroke = self.strokeFactory.generateStrokeByParameters("豎", [211], startPoint=(124, 27))
		self.ds.draw(stroke)
		self.assertEqual("0.124.27,1.124.238", self.controller.getStrokeExpression())

	def test_draw_stroke_3(self):
		stroke = self.strokeFactory.generateStrokeByParameters("豎彎", [146, 126, 32], startPoint=(43, 54))
		self.ds.draw(stroke)
