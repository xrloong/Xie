...
from xie.graphics.factory import genVerticalPanes, genHorizontalPanes
...
class PaneUtilsTestCase(unittest.TestCase):
	...
	def test_genVerticalPanes(self):
		self.assertEqual(genVerticalPanes([1, 2, 3], ShapeFactory.DefaultBox),
				[Pane(8, 4, 247, 39), Pane(8, 47, 247, 119), Pane(8, 131, 247, 239)])
		self.assertEqual(genVerticalPanes([3, 2], ShapeFactory.DefaultBox),
				[Pane(8, 14, 247, 143), Pane(8, 153, 247, 238)])

	def test_genHorizontalPanes(self):
		self.assertEqual(genHorizontalPanes([1, 2, 3], ShapeFactory.DefaultBox),
				[Pane(4, 8, 39, 247), Pane(47, 8, 119, 247), Pane(131, 8, 239, 247)])
		self.assertEqual(genHorizontalPanes([3, 2], ShapeFactory.DefaultBox),
