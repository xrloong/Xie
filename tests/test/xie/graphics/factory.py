...
class StrokeFactoryTestCase(unittest.TestCase):
	...
	def generateTestDataStrokePaths(self):
		...
		self.strokePath_點_1_r = StrokePath([
			BeelineSegment((5, 95))
			])
		self.strokePath_點_2_r = StrokePath([
			BeelineSegment((20, 122))
			])
		self.strokePath_點_3_r = StrokePath([
			BeelineSegment((125, 46))
			])
		self.strokePath_點_4_r = StrokePath([
		...
		self.strokePath_橫_1_r = StrokePath([
			BeelineSegment((30, 0))
			])
		self.strokePath_橫_2_r = StrokePath([
			BeelineSegment((124, 0))
			])
		self.strokePath_橫_3_r = StrokePath([
			BeelineSegment((13, 0))
			])
		self.strokePath_橫_4_r = StrokePath([
		...
		self.strokePath_橫鉤_1_r = StrokePath([
			BeelineSegment((103, 0)),
			BeelineSegment((-125, 68))
			])
		self.strokePath_橫鉤_2_r = StrokePath([
			BeelineSegment((81, 0)),
			BeelineSegment((-38, 54))
			])
		self.strokePath_橫鉤_3_r = StrokePath([
			BeelineSegment((72, 0)),
			BeelineSegment((-3, 124))
			])
		self.strokePath_橫鉤_4_r = StrokePath([
			BeelineSegment((94, 0)),
		...
		self.strokePath_橫折_1_r = StrokePath([
			BeelineSegment((72, 0)),
			BeelineSegment((0, 122))
			])
		self.strokePath_橫折_2_r = StrokePath([
			BeelineSegment((113, 0)),
			BeelineSegment((0, 115))
			])
		self.strokePath_橫折_3_r = StrokePath([
			BeelineSegment((46, 0)),
			BeelineSegment((0, 89))
			])
		self.strokePath_橫折_4_r = StrokePath([
		...
		self.strokePath_橫折折_1_r = StrokePath([
				BeelineSegment((94, 0)),
				BeelineSegment((0, 34)),
				BeelineSegment((33, 0))
			])
		self.strokePath_橫折折_2_r = StrokePath([
				BeelineSegment((33, 0)),
				BeelineSegment((0, 6)),
				BeelineSegment((40, 0))
			])
		self.strokePath_橫折折_3_r = StrokePath([
				BeelineSegment((30, 0)),
				BeelineSegment((0, 115)),
				BeelineSegment((19, 0))
			])
		self.strokePath_橫折折_4_r = StrokePath([
				BeelineSegment((105, 0)),
				BeelineSegment((0, 43)),
				BeelineSegment((53, 0))
			])
		...
		self.strokePath_橫折提_1_r = StrokePath([
				BeelineSegment((32, 0)),
				BeelineSegment((0, 123)),
				BeelineSegment((58, -62))
			])
		self.strokePath_橫折提_2_r = StrokePath([
				BeelineSegment((107, 0)),
				BeelineSegment((0, 36)),
				BeelineSegment((73, -50))
			])
		self.strokePath_橫折提_3_r = StrokePath([
				BeelineSegment((86, 0)),
				BeelineSegment((0, 122)),
				BeelineSegment((46, -90))
			])
		self.strokePath_橫折提_4_r = StrokePath([
				BeelineSegment((55, 0)),
				BeelineSegment((0, 38)),
		...
		self.strokePath_橫折折撇_1_r = StrokePath([
				BeelineSegment((64, 0)),
				BeelineSegment((-123, 53)),
				BeelineSegment((44, 0)),
				BeelineSegment((-47, 7))
			])
		self.strokePath_橫折折撇_2_r = StrokePath([
				BeelineSegment((36, 0)),
				BeelineSegment((-104, 120)),
				BeelineSegment((46, 0)),
				BeelineSegment((-44, 107))
			])
		self.strokePath_橫折折撇_3_r = StrokePath([
				BeelineSegment((68, 0)),
				BeelineSegment((-46, 47)),
				BeelineSegment((21, 0)),
				BeelineSegment((-10, 101))
			])
		self.strokePath_橫折折撇_4_r = StrokePath([
		...
		self.strokePath_橫折彎_1_r = StrokePath([
				BeelineSegment((114, 0)),
				BeelineSegment((0, 79)),
				QCurveSegment([0, 5], [5, 5]),
				BeelineSegment((103, 0))
			])
		self.strokePath_橫折彎_2_r = StrokePath([
				BeelineSegment((81, 0)),
				BeelineSegment((0, 63)),
				QCurveSegment([0, 1], [1, 1]),
				BeelineSegment((114, 0))
			])
		self.strokePath_橫折彎_3_r = StrokePath([
				BeelineSegment((11, 0)),
				BeelineSegment((0, 41)),
				QCurveSegment([0, 2], [2, 2]),
				BeelineSegment((42, 0))
			])
		self.strokePath_橫折彎_4_r = StrokePath([
				BeelineSegment((94, 0)),
				BeelineSegment((0, 34)),
		...
		self.strokePath_橫撇_1_r = StrokePath([
				BeelineSegment((4, 0)),
				BeelineSegment((-90, 127))
			])
		self.strokePath_橫撇_2_r = StrokePath([
				BeelineSegment((26, 0)),
				BeelineSegment((-94, 42))
			])
		self.strokePath_橫撇_3_r = StrokePath([
				BeelineSegment((99, 0)),
				BeelineSegment((-124, 44))
			])
		self.strokePath_橫撇_4_r = StrokePath([
				BeelineSegment((16, 0)),
		...
		self.strokePath_橫斜彎鉤_1_r = StrokePath([
				BeelineSegment((18, 0)),
		...
		self.strokePath_橫斜彎鉤_2_r = StrokePath([
				BeelineSegment((79, 0)),
		...
		self.strokePath_橫斜彎鉤_3_r = StrokePath([
				BeelineSegment((76, 0)),
				BeelineSegment([-1, 2]),
		...
		self.strokePath_橫斜彎鉤_4_r = StrokePath([
		...
		self.strokePath_橫折折折鉤_1_r = StrokePath([
				BeelineSegment((97, 0)),
		...
		self.strokePath_橫折折折鉤_2_r = StrokePath([
		...
		self.strokePath_橫折折折鉤_3_r = StrokePath([
				BeelineSegment((33, 0)),
		...
		self.strokePath_橫折折折鉤_4_r = StrokePath([
				BeelineSegment((115, 0)),
		...
		self.strokePath_橫斜鉤_1_r = StrokePath([
				BeelineSegment((105, 0)),
				QCurveSegment((4, 9), (22, 12)),
				BeelineSegment((0, -14))
			])
		self.strokePath_橫斜鉤_2_r = StrokePath([
				BeelineSegment((89, 0)),
				QCurveSegment((17, 80), (87, 100)),
				BeelineSegment((0, -43))
			])
		self.strokePath_橫斜鉤_3_r = StrokePath([
				BeelineSegment((95, 0)),
				QCurveSegment((6, 63), (30, 79)),
				BeelineSegment((0, -106))
			])
		self.strokePath_橫斜鉤_4_r = StrokePath([
				BeelineSegment((60, 0)),
		...
		self.strokePath_橫折折折_1_r = StrokePath([
				BeelineSegment((14, 0)),
				BeelineSegment((0, 97)),
				BeelineSegment((45, 0)),
				BeelineSegment((0, 63))
			])
		self.strokePath_橫折折折_2_r = StrokePath([
				BeelineSegment((21, 0)),
				BeelineSegment((0, 32)),
				BeelineSegment((20, 0)),
				BeelineSegment((0, 15))
			])
		self.strokePath_橫折折折_3_r = StrokePath([
				BeelineSegment((95, 0)),
				BeelineSegment((0, 4)),
				BeelineSegment((22, 0)),
				BeelineSegment((0, 11))
			])
		self.strokePath_橫折折折_4_r = StrokePath([
				BeelineSegment((16, 0)),
				BeelineSegment((0, 29)),
				BeelineSegment((29, 0)),
		...
		self.strokePath_豎_1_r = StrokePath([
				BeelineSegment((0, 55))
			])
		self.strokePath_豎_2_r = StrokePath([
				BeelineSegment((0, 112))
			])
		self.strokePath_豎_3_r = StrokePath([
				BeelineSegment((0, 50))
			])
		self.strokePath_豎_4_r = StrokePath([
		...
		self.strokePath_豎折_1_r = StrokePath([
				BeelineSegment((0, 72)),
				BeelineSegment((84, 0))
			])
		self.strokePath_豎折_2_r = StrokePath([
				BeelineSegment((0, 104)),
				BeelineSegment((7, 0))
			])
		self.strokePath_豎折_3_r = StrokePath([
				BeelineSegment((0, 121)),
				BeelineSegment((75, 0))
			])
		self.strokePath_豎折_4_r = StrokePath([
				BeelineSegment((0, 3)),
				BeelineSegment((15, 0))
			])
		...
		self.strokePath_豎彎左_1_r = StrokePath([
			BeelineSegment((0, 81)),
			BeelineSegment((-25, 0))
			])
		self.strokePath_豎彎左_2_r = StrokePath([
			BeelineSegment((0, 3)),
			BeelineSegment((-24, 0))
			])
		self.strokePath_豎彎左_3_r = StrokePath([
			BeelineSegment((0, 38)),
			BeelineSegment((-101, 0))
			])
		self.strokePath_豎彎左_4_r = StrokePath([
		...
		self.strokePath_豎提_1_r = StrokePath([
				BeelineSegment((0, 66)),
				BeelineSegment((65, -114))
			])
		self.strokePath_豎提_2_r = StrokePath([
				BeelineSegment((0, 27)),
				BeelineSegment((4, -54))
			])
		self.strokePath_豎提_3_r = StrokePath([
				BeelineSegment((0, 14)),
				BeelineSegment((72, -9))
			])
		self.strokePath_豎提_4_r = StrokePath([
				BeelineSegment((0, 25)),
		...
		self.strokePath_豎折折_1_r = StrokePath([
				BeelineSegment((0, 43)),
				BeelineSegment((91, 0)),
				BeelineSegment((0, 89))
			])
		self.strokePath_豎折折_2_r = StrokePath([
				BeelineSegment((0, 81)),
				BeelineSegment((118, 0)),
				BeelineSegment((0, 25))
			])
		self.strokePath_豎折折_3_r = StrokePath([
				BeelineSegment((0, 85)),
				BeelineSegment((59, 0)),
				BeelineSegment((0, 104))
			])
		self.strokePath_豎折折_4_r = StrokePath([
				BeelineSegment((0, 39)),
				BeelineSegment((100, 0)),
				BeelineSegment((0, 32))
			])
		...
		self.strokePath_豎彎鉤_1_r = StrokePath([
				BeelineSegment((0, 33)),
				QCurveSegment([0, 91], [91, 91]),
				BeelineSegment((3, 0)),
				BeelineSegment((0, -80))
			])
		self.strokePath_豎彎鉤_2_r = StrokePath([
				BeelineSegment((0, 59)),
				QCurveSegment([0, 44], [44, 44]),
				BeelineSegment((78, 0)),
				BeelineSegment((0, -90))
			])
		self.strokePath_豎彎鉤_3_r = StrokePath([
				BeelineSegment((0, 20)),
				QCurveSegment([0, 102], [102, 102]),
				BeelineSegment((22, 0)),
				BeelineSegment((0, -49))
			])
		self.strokePath_豎彎鉤_4_r = StrokePath([
				BeelineSegment((0, 17)),
		...
		self.strokePath_豎彎_1_r = StrokePath([
				BeelineSegment((0, 76)),
				QCurveSegment([0, 100], [100, 100]),
				BeelineSegment((13, 0))
			])
		self.strokePath_豎彎_2_r = StrokePath([
				BeelineSegment((0, 93)),
				QCurveSegment([0, 3], [3, 3]),
				BeelineSegment((56, 0))
			])
		self.strokePath_豎彎_3_r = StrokePath([
				BeelineSegment((0, 127)),
				QCurveSegment([0, 75], [75, 75]),
				BeelineSegment((30, 0))
			])
		self.strokePath_豎彎_4_r = StrokePath([
				BeelineSegment((0, 7)),
		...
		self.strokePath_斜鉤_1_r = StrokePath([
				QCurveSegment((24, 14), (121, 18)),
				BeelineSegment((0, -56))
			])
		self.strokePath_斜鉤_2_r = StrokePath([
				QCurveSegment((12, 55), (64, 69)),
				BeelineSegment((0, -70))
			])
		self.strokePath_斜鉤_3_r = StrokePath([
				QCurveSegment((17, 12), (86, 15)),
				BeelineSegment((0, -98))
			])
		self.strokePath_斜鉤_4_r = StrokePath([
		...
		self.strokePath_撇_1_r = StrokePath([
				BeelineSegment((-64, 100))
			])
		self.strokePath_撇_2_r = StrokePath([
				BeelineSegment((-13, 120))
			])
		self.strokePath_撇_3_r = StrokePath([
				BeelineSegment((-40, 91))
			])
		self.strokePath_撇_4_r = StrokePath([
		...
		self.strokePath_撇點_1_r = StrokePath([
				BeelineSegment((-104, 96)),
				BeelineSegment((86, 60))
			])
		self.strokePath_撇點_2_r = StrokePath([
				BeelineSegment((-51, 18)),
				BeelineSegment((126, 64))
			])
		self.strokePath_撇點_3_r = StrokePath([
				BeelineSegment((-127, 93)),
				BeelineSegment((43, 11))
			])
		self.strokePath_撇點_4_r = StrokePath([
		...
		self.strokePath_撇橫_1_r = StrokePath([
				BeelineSegment((-36, 42)),
				BeelineSegment((82, 5))
			])
		self.strokePath_撇橫_2_r = StrokePath([
				BeelineSegment((-64, 34)),
				BeelineSegment((23, 110))
			])
		self.strokePath_撇橫_3_r = StrokePath([
				BeelineSegment((-30, 121)),
				BeelineSegment((67, 75))
			])
		self.strokePath_撇橫_4_r = StrokePath([
		...
		self.strokePath_撇橫撇_1_r = StrokePath([
				BeelineSegment((-69, 71)),
				BeelineSegment((86, 0)),
				BeelineSegment((-20, 22))
			])
		self.strokePath_撇橫撇_2_r = StrokePath([
				BeelineSegment((-72, 72)),
				BeelineSegment((21, 0)),
				BeelineSegment((-2, 2))
			])
		self.strokePath_撇橫撇_3_r = StrokePath([
				BeelineSegment((-80, 52)),
				BeelineSegment((1, 0)),
				BeelineSegment((-37, 117))
			])
		self.strokePath_撇橫撇_4_r = StrokePath([
		...
		self.strokePath_豎撇_1_r = StrokePath([
				BeelineSegment((0, 6)),
				QCurveSegment((0, 6), (-89, 6))
			])
		self.strokePath_豎撇_2_r = StrokePath([
				BeelineSegment((0, 5)),
				QCurveSegment((0, 5), (-74, 5))
			])
		self.strokePath_豎撇_3_r = StrokePath([
				BeelineSegment((0, 33)),
				QCurveSegment((0, 32), (-10, 32))
			])
		self.strokePath_豎撇_4_r = StrokePath([
				BeelineSegment((0, 36)),
		...
		self.strokePath_提_1_r = StrokePath([
				BeelineSegment((7, -17))
			])
		self.strokePath_提_2_r = StrokePath([
				BeelineSegment((121, -62))
			])
		self.strokePath_提_3_r = StrokePath([
				BeelineSegment((52, -93))
			])
		self.strokePath_提_4_r = StrokePath([
		...
		self.strokePath_捺_1_r = StrokePath([
				QCurveSegment((35.0, 62.0), (107, 63))
			])
		self.strokePath_捺_2_r = StrokePath([
				QCurveSegment((47.0, 26.0), (101, 27))
			])
		self.strokePath_捺_3_r = StrokePath([
				QCurveSegment((41.0, 54.0), (109, 55))
			])
		self.strokePath_捺_4_r = StrokePath([
		...
		self.strokePath_提捺_1_r = StrokePath([
				BeelineSegment((14, -43)),
				QCurveSegment((9, 36), (46, 43))
			])
		self.strokePath_提捺_2_r = StrokePath([
				BeelineSegment((2, -26)),
				QCurveSegment((0.0, 45.0), (41, 66))
			])
		self.strokePath_提捺_3_r = StrokePath([
				BeelineSegment((93, -18)),
				QCurveSegment((60.0, 6.0), (120, 6))
			])
		self.strokePath_提捺_4_r = StrokePath([
		...
		self.strokePath_橫捺_1_r = StrokePath([
				BeelineSegment((49, 0)),
				QCurveSegment((0.0, 23.0), (17, 40))
			])
		self.strokePath_橫捺_2_r = StrokePath([
				BeelineSegment((64, 0)),
				QCurveSegment((19, 77), (98, 91))
			])
		self.strokePath_橫捺_3_r = StrokePath([
				BeelineSegment((12, 0)),
				QCurveSegment((11.0, 12.0), (26, 12))
			])
		self.strokePath_橫捺_4_r = StrokePath([
	...
	def testStrokePath_點(self):
		self.assertEqual(self.strokePath_點_1, self.strokePath_點_1_r)
		self.assertEqual(self.strokePath_點_2, self.strokePath_點_2_r)
		self.assertEqual(self.strokePath_點_3, self.strokePath_點_3_r)
		self.assertEqual(self.strokePath_點_4, self.strokePath_點_4_r)

	def testStrokePath_圈(self):
		self.assertEqual(self.strokePath_圈_1, self.strokePath_圈_1_r)
		self.assertEqual(self.strokePath_圈_2, self.strokePath_圈_2_r)
		self.assertEqual(self.strokePath_圈_3, self.strokePath_圈_3_r)
		self.assertEqual(self.strokePath_圈_4, self.strokePath_圈_4_r)

	def testStrokePath_橫(self):
		self.assertEqual(self.strokePath_橫_1, self.strokePath_橫_1_r)
		self.assertEqual(self.strokePath_橫_2, self.strokePath_橫_2_r)
		self.assertEqual(self.strokePath_橫_3, self.strokePath_橫_3_r)
		self.assertEqual(self.strokePath_橫_4, self.strokePath_橫_4_r)

	def testStrokePath_橫鉤(self):
		self.assertEqual(self.strokePath_橫鉤_1, self.strokePath_橫鉤_1_r)
		self.assertEqual(self.strokePath_橫鉤_2, self.strokePath_橫鉤_2_r)
		self.assertEqual(self.strokePath_橫鉤_3, self.strokePath_橫鉤_3_r)
		self.assertEqual(self.strokePath_橫鉤_4, self.strokePath_橫鉤_4_r)

	def testStrokePath_橫折(self):
		self.assertEqual(self.strokePath_橫折_1, self.strokePath_橫折_1_r)
		self.assertEqual(self.strokePath_橫折_2, self.strokePath_橫折_2_r)
		self.assertEqual(self.strokePath_橫折_3, self.strokePath_橫折_3_r)
		self.assertEqual(self.strokePath_橫折_4, self.strokePath_橫折_4_r)

	def testStrokePath_橫折折(self):
		self.assertEqual(self.strokePath_橫折折_1, self.strokePath_橫折折_1_r)
		self.assertEqual(self.strokePath_橫折折_2, self.strokePath_橫折折_2_r)
		self.assertEqual(self.strokePath_橫折折_3, self.strokePath_橫折折_3_r)
		self.assertEqual(self.strokePath_橫折折_4, self.strokePath_橫折折_4_r)

	def testStrokePath_橫折提(self):
		self.assertEqual(self.strokePath_橫折提_1, self.strokePath_橫折提_1_r)
		self.assertEqual(self.strokePath_橫折提_2, self.strokePath_橫折提_2_r)
		self.assertEqual(self.strokePath_橫折提_3, self.strokePath_橫折提_3_r)
		self.assertEqual(self.strokePath_橫折提_4, self.strokePath_橫折提_4_r)

	def testStrokePath_橫折折撇(self):
		self.assertEqual(self.strokePath_橫折折撇_1, self.strokePath_橫折折撇_1_r)
		self.assertEqual(self.strokePath_橫折折撇_2, self.strokePath_橫折折撇_2_r)
		self.assertEqual(self.strokePath_橫折折撇_3, self.strokePath_橫折折撇_3_r)
		self.assertEqual(self.strokePath_橫折折撇_4, self.strokePath_橫折折撇_4_r)

	def testStrokePath_橫撇彎鉤(self):
		self.assertEqual(self.strokePath_橫撇彎鉤_1, self.strokePath_橫撇彎鉤_1_r)
		self.assertEqual(self.strokePath_橫撇彎鉤_2, self.strokePath_橫撇彎鉤_2_r)
		self.assertEqual(self.strokePath_橫撇彎鉤_3, self.strokePath_橫撇彎鉤_3_r)
		self.assertEqual(self.strokePath_橫撇彎鉤_4, self.strokePath_橫撇彎鉤_4_r)

	def testStrokePath_橫折鉤(self):
		self.assertEqual(self.strokePath_橫折鉤_1, self.strokePath_橫折鉤_1_r)
		self.assertEqual(self.strokePath_橫折鉤_2, self.strokePath_橫折鉤_2_r)
		self.assertEqual(self.strokePath_橫折鉤_3, self.strokePath_橫折鉤_3_r)
		self.assertEqual(self.strokePath_橫折鉤_4, self.strokePath_橫折鉤_4_r)

	def testStrokePath_橫折彎(self):
		self.assertEqual(self.strokePath_橫折彎_1, self.strokePath_橫折彎_1_r)
		self.assertEqual(self.strokePath_橫折彎_2, self.strokePath_橫折彎_2_r)
		self.assertEqual(self.strokePath_橫折彎_3, self.strokePath_橫折彎_3_r)
		self.assertEqual(self.strokePath_橫折彎_4, self.strokePath_橫折彎_4_r)

	def testStrokePath_橫撇(self):
		self.assertEqual(self.strokePath_橫撇_1, self.strokePath_橫撇_1_r)
		self.assertEqual(self.strokePath_橫撇_2, self.strokePath_橫撇_2_r)
		self.assertEqual(self.strokePath_橫撇_3, self.strokePath_橫撇_3_r)
		self.assertEqual(self.strokePath_橫撇_4, self.strokePath_橫撇_4_r)

	def testStrokePath_橫斜彎鉤(self):
		self.assertEqual(self.strokePath_橫斜彎鉤_1, self.strokePath_橫斜彎鉤_1_r)
		self.assertEqual(self.strokePath_橫斜彎鉤_2, self.strokePath_橫斜彎鉤_2_r)
		self.assertEqual(self.strokePath_橫斜彎鉤_3, self.strokePath_橫斜彎鉤_3_r)
		self.assertEqual(self.strokePath_橫斜彎鉤_4, self.strokePath_橫斜彎鉤_4_r)

	def testStrokePath_橫折折折鉤(self):
		self.assertEqual(self.strokePath_橫折折折鉤_1, self.strokePath_橫折折折鉤_1_r)
		self.assertEqual(self.strokePath_橫折折折鉤_2, self.strokePath_橫折折折鉤_2_r)
		self.assertEqual(self.strokePath_橫折折折鉤_3, self.strokePath_橫折折折鉤_3_r)
		self.assertEqual(self.strokePath_橫折折折鉤_4, self.strokePath_橫折折折鉤_4_r)

	def testStrokePath_橫斜鉤(self):
		self.assertEqual(self.strokePath_橫斜鉤_1, self.strokePath_橫斜鉤_1_r)
		self.assertEqual(self.strokePath_橫斜鉤_2, self.strokePath_橫斜鉤_2_r)
		self.assertEqual(self.strokePath_橫斜鉤_3, self.strokePath_橫斜鉤_3_r)
		self.assertEqual(self.strokePath_橫斜鉤_4, self.strokePath_橫斜鉤_4_r)

	def testStrokePath_橫折折折(self):
		self.assertEqual(self.strokePath_橫折折折_1, self.strokePath_橫折折折_1_r)
		self.assertEqual(self.strokePath_橫折折折_2, self.strokePath_橫折折折_2_r)
		self.assertEqual(self.strokePath_橫折折折_3, self.strokePath_橫折折折_3_r)
		self.assertEqual(self.strokePath_橫折折折_4, self.strokePath_橫折折折_4_r)

	def testStrokePath_豎(self):
		self.assertEqual(self.strokePath_豎_1, self.strokePath_豎_1_r)
		self.assertEqual(self.strokePath_豎_2, self.strokePath_豎_2_r)
		self.assertEqual(self.strokePath_豎_3, self.strokePath_豎_3_r)
		self.assertEqual(self.strokePath_豎_4, self.strokePath_豎_4_r)

	def testStrokePath_豎折(self):
		self.assertEqual(self.strokePath_豎折_1, self.strokePath_豎折_1_r)
		self.assertEqual(self.strokePath_豎折_2, self.strokePath_豎折_2_r)
		self.assertEqual(self.strokePath_豎折_3, self.strokePath_豎折_3_r)
		self.assertEqual(self.strokePath_豎折_4, self.strokePath_豎折_4_r)

	def testStrokePath_豎彎左(self):
		self.assertEqual(self.strokePath_豎彎左_1, self.strokePath_豎彎左_1_r)
		self.assertEqual(self.strokePath_豎彎左_2, self.strokePath_豎彎左_2_r)
		self.assertEqual(self.strokePath_豎彎左_3, self.strokePath_豎彎左_3_r)
		self.assertEqual(self.strokePath_豎彎左_4, self.strokePath_豎彎左_4_r)

	def testStrokePath_豎提(self):
		self.assertEqual(self.strokePath_豎提_1, self.strokePath_豎提_1_r)
		self.assertEqual(self.strokePath_豎提_2, self.strokePath_豎提_2_r)
		self.assertEqual(self.strokePath_豎提_3, self.strokePath_豎提_3_r)
		self.assertEqual(self.strokePath_豎提_4, self.strokePath_豎提_4_r)

	def testStrokePath_豎折折(self):
		self.assertEqual(self.strokePath_豎折折_1, self.strokePath_豎折折_1_r)
		self.assertEqual(self.strokePath_豎折折_2, self.strokePath_豎折折_2_r)
		self.assertEqual(self.strokePath_豎折折_3, self.strokePath_豎折折_3_r)
		self.assertEqual(self.strokePath_豎折折_4, self.strokePath_豎折折_4_r)

	def testStrokePath_豎折彎鉤(self):
		self.assertEqual(self.strokePath_豎折彎鉤_1, self.strokePath_豎折彎鉤_1_r)
		self.assertEqual(self.strokePath_豎折彎鉤_2, self.strokePath_豎折彎鉤_2_r)
		self.assertEqual(self.strokePath_豎折彎鉤_3, self.strokePath_豎折彎鉤_3_r)
		self.assertEqual(self.strokePath_豎折彎鉤_4, self.strokePath_豎折彎鉤_4_r)

	def testStrokePath_豎彎鉤(self):
		self.assertEqual(self.strokePath_豎彎鉤_1, self.strokePath_豎彎鉤_1_r)
		self.assertEqual(self.strokePath_豎彎鉤_2, self.strokePath_豎彎鉤_2_r)
		self.assertEqual(self.strokePath_豎彎鉤_3, self.strokePath_豎彎鉤_3_r)
		self.assertEqual(self.strokePath_豎彎鉤_4, self.strokePath_豎彎鉤_4_r)

	def testStrokePath_豎彎(self):
		self.assertEqual(self.strokePath_豎彎_1, self.strokePath_豎彎_1_r)
		self.assertEqual(self.strokePath_豎彎_2, self.strokePath_豎彎_2_r)
		self.assertEqual(self.strokePath_豎彎_3, self.strokePath_豎彎_3_r)
		self.assertEqual(self.strokePath_豎彎_4, self.strokePath_豎彎_4_r)

	def testStrokePath_豎鉤(self):
		self.assertEqual(self.strokePath_豎鉤_1, self.strokePath_豎鉤_1_r)
		self.assertEqual(self.strokePath_豎鉤_2, self.strokePath_豎鉤_2_r)
		self.assertEqual(self.strokePath_豎鉤_3, self.strokePath_豎鉤_3_r)
		self.assertEqual(self.strokePath_豎鉤_4, self.strokePath_豎鉤_4_r)

	def testStrokePath_斜鉤(self):
		self.assertEqual(self.strokePath_斜鉤_1, self.strokePath_斜鉤_1_r)
		self.assertEqual(self.strokePath_斜鉤_2, self.strokePath_斜鉤_2_r)
		self.assertEqual(self.strokePath_斜鉤_3, self.strokePath_斜鉤_3_r)
		self.assertEqual(self.strokePath_斜鉤_4, self.strokePath_斜鉤_4_r)

	def testStrokePath_彎鉤(self):
		self.assertEqual(self.strokePath_彎鉤_1, self.strokePath_彎鉤_1_r)
		self.assertEqual(self.strokePath_彎鉤_2, self.strokePath_彎鉤_2_r)
		self.assertEqual(self.strokePath_彎鉤_3, self.strokePath_彎鉤_3_r)
		self.assertEqual(self.strokePath_彎鉤_4, self.strokePath_彎鉤_4_r)

	def testStrokePath_撇鉤(self):
		self.assertEqual(self.strokePath_撇鉤_1, self.strokePath_撇鉤_1_r)
		self.assertEqual(self.strokePath_撇鉤_2, self.strokePath_撇鉤_2_r)
		self.assertEqual(self.strokePath_撇鉤_3, self.strokePath_撇鉤_3_r)
		self.assertEqual(self.strokePath_撇鉤_4, self.strokePath_撇鉤_4_r)

	def testStrokePath_撇(self):
		self.assertEqual(self.strokePath_撇_1, self.strokePath_撇_1_r)
		self.assertEqual(self.strokePath_撇_2, self.strokePath_撇_2_r)
		self.assertEqual(self.strokePath_撇_3, self.strokePath_撇_3_r)
		self.assertEqual(self.strokePath_撇_4, self.strokePath_撇_4_r)

	def testStrokePath_撇點(self):
		self.assertEqual(self.strokePath_撇點_1, self.strokePath_撇點_1_r)
		self.assertEqual(self.strokePath_撇點_2, self.strokePath_撇點_2_r)
		self.assertEqual(self.strokePath_撇點_3, self.strokePath_撇點_3_r)
		self.assertEqual(self.strokePath_撇點_4, self.strokePath_撇點_4_r)

	def testStrokePath_撇橫(self):
		self.assertEqual(self.strokePath_撇橫_1, self.strokePath_撇橫_1_r)
		self.assertEqual(self.strokePath_撇橫_2, self.strokePath_撇橫_2_r)
		self.assertEqual(self.strokePath_撇橫_3, self.strokePath_撇橫_3_r)
		self.assertEqual(self.strokePath_撇橫_4, self.strokePath_撇橫_4_r)

	def testStrokePath_撇橫撇(self):
		self.assertEqual(self.strokePath_撇橫撇_1, self.strokePath_撇橫撇_1_r)
		self.assertEqual(self.strokePath_撇橫撇_2, self.strokePath_撇橫撇_2_r)
		self.assertEqual(self.strokePath_撇橫撇_3, self.strokePath_撇橫撇_3_r)
		self.assertEqual(self.strokePath_撇橫撇_4, self.strokePath_撇橫撇_4_r)

	def testStrokePath_豎撇(self):
		self.assertEqual(self.strokePath_豎撇_1, self.strokePath_豎撇_1_r)
		self.assertEqual(self.strokePath_豎撇_2, self.strokePath_豎撇_2_r)
		self.assertEqual(self.strokePath_豎撇_3, self.strokePath_豎撇_3_r)
		self.assertEqual(self.strokePath_豎撇_4, self.strokePath_豎撇_4_r)

	def testStrokePath_提(self):
		self.assertEqual(self.strokePath_提_1, self.strokePath_提_1_r)
		self.assertEqual(self.strokePath_提_2, self.strokePath_提_2_r)
		self.assertEqual(self.strokePath_提_3, self.strokePath_提_3_r)
		self.assertEqual(self.strokePath_提_4, self.strokePath_提_4_r)

	def testStrokePath_捺(self):
		self.assertEqual(self.strokePath_捺_1, self.strokePath_捺_1_r)
		self.assertEqual(self.strokePath_捺_2, self.strokePath_捺_2_r)
		self.assertEqual(self.strokePath_捺_3, self.strokePath_捺_3_r)
		self.assertEqual(self.strokePath_捺_4, self.strokePath_捺_4_r)

	def testStrokePath_臥捺(self):
		self.assertEqual(self.strokePath_臥捺_1, self.strokePath_臥捺_1_r)
		self.assertEqual(self.strokePath_臥捺_2, self.strokePath_臥捺_2_r)
		self.assertEqual(self.strokePath_臥捺_3, self.strokePath_臥捺_3_r)
		self.assertEqual(self.strokePath_臥捺_4, self.strokePath_臥捺_4_r)

	def testStrokePath_提捺(self):
		self.assertEqual(self.strokePath_提捺_1, self.strokePath_提捺_1_r)
		self.assertEqual(self.strokePath_提捺_2, self.strokePath_提捺_2_r)
		self.assertEqual(self.strokePath_提捺_3, self.strokePath_提捺_3_r)
		self.assertEqual(self.strokePath_提捺_4, self.strokePath_提捺_4_r)

	def testStrokePath_橫捺(self):
		self.assertEqual(self.strokePath_橫捺_1, self.strokePath_橫捺_1_r)
		self.assertEqual(self.strokePath_橫捺_2, self.strokePath_橫捺_2_r)
		self.assertEqual(self.strokePath_橫捺_3, self.strokePath_橫捺_3_r)
		self.assertEqual(self.strokePath_橫捺_4, self.strokePath_橫捺_4_r)
